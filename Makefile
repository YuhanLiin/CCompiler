...
devtest: driver.c test/maintest.c test/utils.c io/file.c io/error.c lexer/lexer.c array.c parser/parser.c parser/shared.c parser/parse_expr.c ast/ast.c ast/type.c semantics/semantics.c codegen/codegen.c scope/scope.c semantics/symtable.c codegen/address.c
	${c} ${basedir} -g driver.c test/maintest.c io/file.c io/error.c lexer/lexer.c array.c parser/parser.c parser/shared.c parser/parse_expr.c ast/ast.c ast/type.c semantics/semantics.c codegen/codegen.c scope/scope.c semantics/symtable.c codegen/address.c -o test/bin/main.exe
